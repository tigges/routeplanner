...
page_cfg = dict(title=cfg['title'], slug=cfg['slug'], trips=TRIPS, networks=NETWORKS, lang=cfg['lang'], proj=proj, forkLabels=cfg.get('forkLabels', {}), optionNames=cfg.get('optionNames', {}),
