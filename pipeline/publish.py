...
<style>body{margin:0;padding:40px 24px;background:#ffffff;color:#12202a;font:16px/1.5 -apple-system,Segoe UI,Helvetica,Arial,sans-serif}
main{max-width:560px;margin:0 auto}h1{font-weight:600;font-size:22px;margin:0 0 6px}p{color:#55636d;margin:0 0 28px}
ul{list-style:none;padding:0;margin:0}li{padding:14px 0;border-top:1px solid #e0e5e9}li:last-child{border-bottom:1px solid #e0e5e9}
a{color:#0f6fbf;font-size:18px;text-decoration:none}a:hover{text-decoration:underline}li span{display:block;color:#7c8b96;font-size:13px}
footer{margin-top:28px;color:#7c8b96;font-size:13px}footer a{color:#55636d;font-size:13px}</style></head><body><main>
